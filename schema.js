    ...
    inquirer
        .prompt([
            {
                ...
                choices: ["Add Department", "Add Employee", "Add Manager", "Add Role", "View Employees", "View Roles", "View Departments", "View Managers"]
            }
            // {
            //     type: "list",
            //     name: "nextChoice",
        ...
        .then((answer) => {
            if (answer.start_prompt === "Add Department") {
                ...
                roleAdd();
            } else if (answer.start_prompt === "View Employees") {
                employeeView();
            } else if (answer.start_prompt === "View Roles") {
                roleView();
            } else if (answer.start_prompt === "View Departments") {
                departmentView();
            } else if (answer.start_prompt === "View Managers") {
                managerView();
            } else {
                connection.end();
            }
                            ...
                            .prompt([
                                ...
                                // {
                                    ...
                                    //     choices() {
                                        ...
                                        const employeeView = () => {
                                            connection.query('SELECT * FROM employee_id', (err, results) => {
                                                console.log(results);
                                                start();
                                                if (err) throw err;
                                            })
